...
add_action('admin_head', 'woo_load_tumblog_css');
...
function woo_load_tumblog_css() {   
    ...
    echo "<link rel='stylesheet' id='colors-tabs' href='".get_bloginfo('template_directory')."/functions/css/validationEngine.jquery.css' type='text/css' media='all' />";
}
